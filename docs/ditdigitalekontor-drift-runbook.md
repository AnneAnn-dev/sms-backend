...
## Udeståender — samlet overblik (pr. 17/7-26)
...
4. **Manifest-tjek (nyt 17/7):** `short_name` i manifest.json (+ `apple-mobile-web-app-title`) skal matche ikon-labelen **"Dit Kontor"** på onboardingens slutside — ellers leder kunden efter en anden tekst end den, vi lige har vist dem.
