...
22/9-26: Testkald på staging fejlede — ingen udgående opkald registreret hos Twilio, ingen fejl i Railway-loggen. Virkede igen efter rollback. Årsag ikke fastslået; muligvis telefon eller midlertidig Twilio-hikke. Hvis det gentager sig: undersøg om fejl fra Twilio ved udgående opkald logges og sendes til AppSignal.
